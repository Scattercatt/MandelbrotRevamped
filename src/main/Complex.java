...
public class Complex extends Object {
    ...
    */
    public Complex add(Complex w) {
        return new Complex(x+w.getR(),y+w.getI());
    }
    ...
    */
    public Complex mult(Complex w) {
        return new Complex(x*w.getR()-y*w.getI(),x*w.getI()+y*w.getR());
    }
    ...
    */
    public Complex div(Complex w) {
        ...
        return new Complex((x*w.getR()+y*w.getI())/den,(y*w.getR()-x*w.getI())/den);
    }
